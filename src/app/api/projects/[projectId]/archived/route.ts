...
export async function GET(
  ...
  const sort = searchParams.get("sort") ?? "archived_at_desc";
  ...
  const orderField =
    sort === "created_at_asc" || sort === "created_at_desc"
      ? "created_at"
      : "archived_at";
  const orderDir =
    sort === "created_at_asc" || sort === "archived_at_asc" ? "asc" : "desc";
